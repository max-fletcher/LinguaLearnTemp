...
export async function getAdminUsers(req: AdminAuthenticatedRequest, res: Response) {
  try {
...
export async function getUserDetails(req: AdminAuthenticatedRequest, res: Response) {
  try {
